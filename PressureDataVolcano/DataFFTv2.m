...
%% ---------------- USER SETTINGS ----------------
nmics        = 1;                 % Total number of probes
df_desired   = 50;                 % Hz per FFT bin
% plot_probes  = [1];      % <<< PROBES TO OVERLAY <<<
...
% path = "C:\Users\bollerma.CEAS1\OneDrive - University of Cincinnati\Masters Research\High Frequency CFD Data\Square Edge Cav - RD00 - 50 kHz 5CTUs\50 kHz Kulite\";
% file = "k6.pressure.dat";
...
pidx = 1;   % convert probe number → MATLAB index

semilogx(f(1:Nfft/2), NB(1:Nfft/2, pidx), ...
        'DisplayName', sprintf('Probe %s', "k6"));
