Workflow for the TimeSensitivityProcessing (works with additional input where the data is .dat file for line probes)
...
3) Run "xlsxSorter.py" to sort the .xlsx files by probe location for 4 different lines (V2: Functionality for 3 lines)
