...
for g = 1:numel(dataTypes)
    ...
    switch dt
        case 'TKE'
            dtPlot  = '\boldmath$\mathbf{TKE}$ \textbf{(J/kg)}';
            dtPlot2 = '\boldmath$\mathbf{TKE}$';
        case 'Rxx'
            dtPlot  = '\boldmath$\mathbf{R}_{xx}$ \textbf{(Pa)}';
            dtPlot2 = '\boldmath$\mathbf{R}_{xx}$';
        case 'Ryy'
            dtPlot  = '\boldmath$\mathbf{R}_{yy}$ \textbf{(Pa)}';
            dtPlot2 = '\boldmath$\mathbf{R}_{yy}$';
        case 'Rzz'
