...
for f = 1:2
    ...
    for a = 1:numel(srcAxes)
        ...
        for c = 1:numel(srcChildren)
            ...
            % Store info for normalized plot
            li.sol        = thisSol;
            li.geomKey    = geomKey;
            li.X          = xData;
            li.Y          = yData;
...
disp('Overlay and normalized overlay of two velocityx*.fig files complete.');
