...
CASE = "J35/RD52si"
VOLCANO_FILE = r"/home/bollerma/LESdata/SSWT/sliceCav/J35/RD52si/SSWTM2RD52InjectSlice_airOnly_000/latest.volcano"
# INPUT_FILES= [
...
print(f"All probe lines extracted successfully for all slices. \nOutput stored in: {OUTPUT_DIR}")
