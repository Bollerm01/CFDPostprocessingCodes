...
INPUT_FILES = [
    r"E:\Boller CFD\CFD Bulk Slice Data\VULCANinjectingComparisonData\vulcan_solution_r3_j1p4.plt",
    r"E:\Boller CFD\CFD Bulk Slice Data\VULCANinjectingComparisonData\vulcan_solution_r3_jp35.plt",
    r"E:\Boller CFD\CFD Bulk Slice Data\VULCANinjectingComparisonData\vulcan_solution_sq_j1p4.plt",
    r"E:\Boller CFD\CFD Bulk Slice Data\VULCANinjectingComparisonData\vulcan_solution_sq_jp35.plt"
]
...
for i in range(len(INPUT_FILES)):
    ...
    OUTPUT_DIR = os.path.join(OUTPUT_ROOT, CASES[i])
