# Paraview Slicing Script for the RC19 Cavity
# Input: latest.volcano file for the RC19 simulation
# Output: Series of .png files for the slice contours in the same folder as the simulation
